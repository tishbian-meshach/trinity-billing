      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-[#00b894]/5 border border-[#00b894]/20 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-[#00b894]">WhatsApp Receipt</span>
          </div>
          <p className="text-xs text-[#8888a0]">
            A Tamil receipt will be automatically sent to the member&apos;s WhatsApp after payment is recorded.
          </p>
        </div>
